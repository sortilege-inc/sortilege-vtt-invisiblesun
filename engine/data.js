...
// others — Invisible Sun keeps the 3,532 margin notes out of 'main' so the character
// creator never pays for them). Each data file is a self-registering script: it writes
