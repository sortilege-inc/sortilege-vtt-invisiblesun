// sortilege-vtt-invisiblesun Worker: the session rooms.
//
...
// @ts-ignore — the system's own ops (scenes, the Path of Suns), registered into the same table
import '../../system/invisiblesun/ops.js';
